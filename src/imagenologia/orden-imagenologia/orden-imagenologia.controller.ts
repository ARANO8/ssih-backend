...
export class OrdenImagenologiaController {
  constructor(private readonly ordenImagenologiaService: OrdenImagenologiaService) {}
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateOrdenImagenologiaDto: UpdateOrdenImagenologiaDto) {
