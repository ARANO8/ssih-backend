...
export class EpisodioAtencionController {
  constructor(private readonly episodioAtencionService: EpisodioAtencionService) {}
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateEpisodioAtencionDto: UpdateEpisodioAtencionDto) {
